...
set workingDirectory /Users/username/Desktop/recurnet_morphproc/2_testing/14t4i2o_language
...
set stimSet "primetest_0.2prime0.0ISI4.0start_2021-01-19_14t4i2oexamples"
...
set stimSet "primetest_0.6prime0.0ISI4.0start_2021-01-19_14t4i2oexamples"
# Load the test examples
loadExamples $workingDirectory/$stimSet.ex  -exmode PERMUTE
useTestingSet $stimSet
# Call procedure wt2out for all wt files in this folder
...
set stimSet "primetest_1.0prime0.0ISI4.0start_2021-01-19_14t4i2oexamples"
# Load the test examples
loadExamples $workingDirectory/$stimSet.ex  -exmode PERMUTE
useTestingSet $stimSet
# Call procedure wt2out for all wt files in this folder
...
set stimSet "primetest_1.4prime0.0ISI4.0start_2021-01-19_14t4i2oexamples"
# Load the test examples
loadExamples $workingDirectory/$stimSet.ex  -exmode PERMUTE
useTestingSet $stimSet
# Call procedure wt2out for all wt files in this folder
...
set stimSet "primetest_1.8prime0.0ISI4.0start_2021-01-19_14t4i2oexamples"
# Load the test examples
loadExamples $workingDirectory/$stimSet.ex  -exmode PERMUTE
useTestingSet $stimSet
# Call procedure wt2out for all wt files in this folder
